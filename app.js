...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const waStrategyUrl = 'https://wa.me/919340722578?text=Hi%20Rahul%2C%20I%20would%20like%20to%20book%20a%20Free%20Strategy%20Call%20for%20my%20business.';

  document.querySelectorAll('.open-contact-btn').forEach(btn => {
    btn.addEventListener('click', (e) => {
      if (btn.tagName.toLowerCase() === 'a' && btn.href && btn.href.includes('wa.me')) {
        return;
      }
      e.preventDefault();
      window.open(waStrategyUrl, '_blank', 'noopener,noreferrer');
    });
  });
